...
<!-- widget one -->
					<div class="sidebar_add_element">
						<div class="left_sidebar_add">
							<p><i class="fa fa-user-plus"></i><span>Add Friend</span></p>
						</div>
						<div class="left_sidebar_add">
							<p><i class="fa fa-envelope"></i><span>Send Message</span></p>
						</div>
                                                <div class="left_sidebar_add">
<p><i class="fa fa-camera"></i><span><a href="album.php" style="color:#fff;">Photos</a></span></p>
						</div>
                                     

<div class="left_sidebar_add">
							<p><i class="fa fa-user-times"></i><span>Block User</span></p>
						</div>
