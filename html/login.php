...
<div id="logincontainer">
   ...
   <div class="signbgwrap">
   	<div class="signbg">
    	<a href=""><div  id="largebluebtn">Sign up using<span>Facebook</span></div></a>
    	<div class="subheading">- or connect the old fashion way -</div>
        <input type="text"  value="" class="locinput2" placeholder="Email">
        <input type="text"  value="" class="locinput2"  placeholder="Password"> 
        <div id="radiobtn"><input type="radio" /> Remember Me</div>
        <input type="submit" value="LOGIN" class="btn_signup" />
		
        <div class="forgotlinks"><a href="forgotpassword.php">Forgot your password?</a><a href="resetpassword.php" class="nomargR">Forgot your username?</a></div>   
            		</div>
   				</div> 
  <div class="logfoot">
  	<div class="fmenu">
