...
$response['getFirst'] = NotificationModel::getFirst($entityManager, $session->getSession('userid'));
...
$req=NotificationModel::getNumber();
$response['getCount']=NotificationModel::getCount($entityManager, $session->getSession('userid'));
