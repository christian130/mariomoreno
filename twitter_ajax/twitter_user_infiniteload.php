    ...
    if ($my_tweet->errors[0]->message == '') {
        ...
        if ($my_tweet[$i]->retweeted_status->id == '') {
            ...
            if ($my_tweet[$i]->entities->media[0]->id_str != '') {
                ...
                $image_are = "<div class='tweet-medias tweet_outer' id='yfrog$k' style='display:none;'><a href='" . $my_tweet[$i]->entities->media[0]->media_url . "' class='fancybox-effects-a' title = 'Photo'><img src='" . $my_tweet[$i]->entities->media[0]->media_url . "' width='" . $my_tweet[$i]->entities->media[0]->sizes->small->w . "px' height='" . $my_tweet[$i]->entities->media[0]->sizes->small->h . "px'></a></div>";
            } else if ($imge_id[0] == 'twitpic.com') {
                $w = $my_tweet[$i]->entities->media[0]->media_url->sizes->large->w;
                $h = $my_tweet[$i]->entities->media[0]->media_url->sizes->large->h;
                $media_flag = '<a href="javascript:void(0)" onclick="displaymedia(' . $k . ')"><i class="sm-image"></i> View photo</a>';
                $image_are = "<div class='tweet-medias tweet_outer' id='yfrog$k' style='display:none;'><a href='http://twitpic.com/show/full/" . $imge_id[1] . ".jpg' class='fancybox-effects-a' title = 'Photo'><img src='http://twitpic.com/show/full/" . $imge_id[1] . ".jpg'></a></div>";
            } else if ($imge_id[0] == 'yfrog.com') {
                $w = $my_tweet[$i]->entities->media[0]->media_url->sizes->large->w;
                $h = $my_tweet[$i]->entities->media[0]->media_url->sizes->large->h;
                $media_flag = '<a href="javascript:void(0)" onclick="displaymedia(' . $k . ')"><i class="sm-image"></i> View photo</a>';
                $image_are = "<div class='tweet-medias tweet_outer' id='yfrog$k' style='display:none;'><a href='http://yfrog.com/" . $imge_id[1] . ":medium' class='fancybox-effects-a' title = 'Photo'><img src='http://yfrog.com/" . $imge_id[1] . ":medium'></a></div>";
                ...
                $image_are = "<div class='tweet-medias tweet_outer' id='yfrog$k' style='display:none;'><object width='425' height='349' type='application/x-shockwave-flash' data='http://www.youtube.com/v/" . $video_id[$len] . "'><param name='movie' value='http://www.youtube.com/v/" . $video_id[$len] . "' /></object>" .
                        "<br><b>" . $title . "</b><br>" .
                        "<b>" . $desc . "</b><br>"
                        . "</div>";
            }else if ($imge_id[0] == 'vine.co') {
                                            $media_flag = '<a href="javascript:void(0)" onclick="displaymedia(' . $k . ')"><i class="sm-image"></i> View Media</a>';
                                            $image_are = "<div class='tweet-medias tweet_outer' id='yfrog$k' style='display:none;'><iframe src='https://vine.co/v/".$imge_id[2]."/card?mute=1' width='300px' height='300px' frameborder='0'></iframe>" .
                                                    "<br><b>" . $title . "</b><br>" .
                                                    "<b>" . $desc . "</b><br>"
                                                    . "</div>";
                                        }
            ...
            if ($my_tweet[$i]->retweeted_status->entities->media[0]->id_str != '') {
                ...
                $media_flag = '<a href="javascript:void(0)" onclick="displaymedia(' . $k . ')"><i class="sm-image"></i> View photo</a>';
                $image_are = "<div class='tweet-medias tweet_outer' id='yfrog$k' style='display:none;'><a href='" . $my_tweet[$i]->retweeted_status->entities->media[0]->media_url . "' class='fancybox-effects-a' title = 'Photo'><img src='" . $my_tweet[$i]->retweeted_status->entities->media[0]->media_url . "' width='" . $my_tweet[$i]->retweeted_status->entities->media[0]->sizes->small->w . "px' height='" . $my_tweet[$i]->retweeted_status->entities->media[0]->sizes->small->h . "px'></a></div>";
            } else if ($imge_id[0] == 'twitpic.com') {
                $w = $my_tweet[$i]->retweeted_status->entities->media[0]->media_url->sizes->large->w;
                $h = $my_tweet[$i]->retweeted_status->entities->media[0]->media_url->sizes->large->h;
                $media_flag = '<a href="javascript:void(0)" onclick="displaymedia(' . $k . ')"><i class="sm-image"></i> View photo</a>';
