				...
				/* echo "<script type='text/javascript'>alert('$session->getSession("friends")');</script>"; */
				 ...
				 //echo base64_decode($_GET['profileid']);
					//echo $session->getSession("userid");
                     ...
                     //echo $mine;
					 if(base64_decode($_GET['profileid'])=="")
					 {
					   $result = Friends::getFriends($entityManager, $session->getSession("userid"), 8);
					 ?>
					 	<a href="friend_list.php?profileid=<?php echo $_GET['profileid'];?>" ><h3 class="">My Friends(<font class="totalfriends"><?php echo Friends::getNumber(); ?></font>)</h3></a>
                    ...
                    <div class="friendwrap">
					 ...
					 if($_SESSION['userid'] == base64_decode($_GET['profileid']) ){
                        ...
                        $result = Friends::getFriends($entityManager, $session->getSession("userid"), 8);
						?>
						<a href="friend_list.php?id=<?php echo $_GET['profileid'];?>" ><h3 class="">My Friends2(<font class="totalfriends"><?php echo Friends::getNumber(); ?></font>)</h3></a>
                    ...
                    }  else if($_SESSION['userid'] != base64_decode($_GET['profileid'])&&base64_decode($_GET['profileid'])!="") {
...
<a href="friend_list.php?id=<?php echo $_GET['profileid'];?>" ><h3 class="">Friends(<font class="totalfriends"><?php echo Friends::getNumber(); ?></font>)</h3></a>
                ...
                <div class="profilelinks">
                    <ul class="mailcontent">
                        <?php if (!$mine) {
                        ?>
                            <li ><a class="sendFriendRequest"><?php echo Friends::isFriendText($entityManager, $session->getSession('userid'), base64_decode($_GET['profileid'])) ?> </a><img src="images/drop.png" id="confirmLink" style="cursor: pointer;"></img>
